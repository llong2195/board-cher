...
/**
 * Card Component (T088 - Performance Optimized)
...
// T088: Memoize Card component to optimize drag-and-drop performance
// Only re-render when card data or onClick handler changes
