...
export function ChecklistSection({
  ...
  const confirmDeleteChecklist = async () => {
    ...
    try {
      await checklistApi.deleteChecklist(deleteChecklistId);
      onUpdate(checklists.filter((cl) => cl.id !== deleteChecklistId));
  ...
  return (
    <div className="space-y-4">
      ...
      <ConfirmDialog
        ...
        description="This will permanently delete the checklist and all its items."
        variant="destructive"
        confirmText="Delete"
      />
    </div>
